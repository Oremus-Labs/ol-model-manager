...
func TestListWeights(t *testing.T) {
	...
	handler := New(nil, nil, store, nil, nil, nil, nil, nil, nil, nil, Options{})
...
func TestInstallWeightsDerivesFilesFromHuggingFace(t *testing.T) {
	...
	handler := New(nil, nil, store, discovery, nil, nil, nil, nil, nil, nil, Options{
...
func TestDeleteJobsEndpoint(t *testing.T) {
	...
	handler := New(nil, nil, nil, nil, nil, nil, nil, stateStore, nil, nil, Options{})
...
func TestInstallWeightsRejectsInvalidHFID(t *testing.T) {
	...
	handler := New(nil, nil, &fakeWeightStore{}, &fakeDiscovery{}, nil, nil, nil, nil, nil, nil, Options{})
...
func TestGenerateCatalogEntry(t *testing.T) {
	...
	handler := New(nil, nil, nil, discovery, nil, nil, nil, nil, nil, nil, Options{})
...
func TestCreateCatalogPR(t *testing.T) {
	...
	handler := New(nil, nil, nil, nil, nil, writer, nil, nil, nil, nil, Options{
		GitHubToken: "token",
	})
...
func TestDescribeVLLMModel(t *testing.T) {
	...
	handler := New(nil, nil, nil, discovery, nil, nil, &fakeAdvisor{}, nil, nil, nil, Options{})
...
func TestSystemInfo(t *testing.T) {
	...
	h := New(&catalog.Catalog{}, nil, wm, nil, nil, nil, &fakeAdvisor{}, nil, nil, nil, Options{
		Version:                "0.0.1",
		CatalogRoot:            "/catalog",
...
func TestListJobsFilters(t *testing.T) {
	...
	st := newTempStore(t)
	h := New(nil, nil, nil, nil, nil, nil, nil, st, nil, nil, Options{HistoryLimit: 5})
...
func TestOpenAPISpecEndpoint(t *testing.T) {
	...
	h := New(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, Options{})
...
func TestSearchHuggingFaceParsesFilters(t *testing.T) {
	...
	h := New(nil, nil, nil, discovery, nil, nil, nil, nil, nil, nil, Options{})
